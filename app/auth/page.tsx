                ...
                >
                  <div className="bg-linear-to-br from-slate-800/40 to-slate-900/40 rounded-lg sm:rounded-xl md:rounded-2xl p-4 sm:p-5 md:p-8 border border-slate-700/40 backdrop-blur-xl">
                    <div className="text-center mb-4 sm:mb-5 md:mb-6">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl font-black text-white mb-1 sm:mb-1.5 md:mb-2">
                        Web3 Wallet
                      </h2>
                      <p className="text-xs sm:text-xs md:text-sm text-slate-400">
                        Connect your wallet for secure access
                      </p>
                    </div>
