...
import { Calendar, User, ChevronRight, Sparkles, Zap } from "lucide-react";
...
export default function Blog() {
  const featuredPost = {
    ...
    excerpt:
      "An in-depth look at the factors driving the recent surge in technology stocks and what it means for investors.",
    image:
  ...
  const posts = [
    {
      ...
      excerpt:
        "Exploring the most promising AI-related investment opportunities as the sector continues to evolve.",
      image:
    ...
    },
    {
      ...
      category: "Strategy",
      excerpt:
        "Understanding the importance of portfolio rebalancing and practical strategies for maintaining optimal asset allocation.",
      image:
    ...
    },
    {
      ...
      category: "Crypto",
      excerpt:
        "Latest trends in the cryptocurrency market and emerging opportunities for digital asset investors.",
      image:
    ...
    },
    {
      ...
      category: "Macro",
      excerpt:
        "Key economic indicators that could impact market performance in the coming months.",
      image:
    ...
    },
    {
      ...
      category: "Income",
      excerpt:
        "Building a dividend-focused portfolio for consistent passive income streams.",
      image:
        "https://images.pexels.com/photos/3532557/pexels-photo-3532557.jpeg?auto=compress&cs=tinysrgb&w=600",
      readTime: "8 min read",
    },
    {
      ...
      category: "Risk",
      excerpt:
        "Essential techniques and strategies to protect your portfolio in volatile market conditions.",
      image:
      ...
      <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-28 pb-8 sm:pb-10 md:pb-12 lg:pb-16 px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 bg-linear-to-b from-finance-dark/50 to-transparent">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-finance-gold font-semibold text-sm uppercase tracking-widest">
              Latest from FinMindAI
            </span>
          </div>
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl">
            Expert analysis, market trends, and investment strategies from
            FinMindAI&apos;s team of seasoned analysts
          </p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="p-6 sm:p-8 md:p-10 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap items-center gap-4 mb-6 text-xs sm:text-sm text-slate-400">
                    ...
                    <span className="text-finance-gold/70">
                ...
                <div className="p-5 sm:p-6 flex flex-col flex-1">
                  ...
                  <div className="space-y-3 pt-3 border-t border-finance-border">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <span className="text-xs text-finance-gold/70 font-medium">
                        {post.readTime}
                      </span>
          ...
          <div className="bg-linear-to-r from-finance-gold/20 via-amber-600/10 to-finance-gold/20 border border-finance-gold/40 rounded-xl p-8 sm:p-10 md:p-12">
            <div className="max-w-2xl mx-auto text-center">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-finance-gold font-bold text-sm uppercase tracking-widest">
                  Weekly Newsletter
                </span>
              </div>
              ...
              <p className="text-slate-400 text-sm sm:text-base mb-8">
                Subscribe to our newsletter for the latest market analysis,
                investment insights, and trading strategies delivered every
                week.
              </p>
