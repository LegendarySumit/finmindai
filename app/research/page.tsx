...
import { TrendingUp, BarChart3, PieChart, Sparkles, ChevronRight, Calendar, ArrowRight, BookOpen, Zap, Star } from 'lucide-react';
...
export default function Research() {
  const featuredReport = {
    ...
    icon: TrendingUp,
    date: 'March 2026',
    excerpt: 'Comprehensive analysis of market trends, economic indicators, and investment opportunities for Q1 2026.',
  ...
  const reports = [
    {
      ...
      icon: BarChart3,
      date: 'February 2026',
      excerpt: 'Detailed breakdown of sector performance across technology, finance, healthcare, and consumer sectors.',
    ...
    },
    {
      ...
      icon: PieChart,
      date: 'January 2026',
      excerpt: 'Strategic asset allocation recommendations based on current market conditions and risk profiles.',
    ...
    },
    {
      ...
      icon: BarChart3,
      date: 'December 2025',
      excerpt: 'Analysis of cryptocurrency market dynamics, emerging opportunities, and regulatory landscape.',
    ...
    },
    {
      ...
      icon: TrendingUp,
      date: 'November 2025',
      excerpt: 'Key economic metrics including GDP growth, inflation rates, and employment trends worldwide.',
      ...
      <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-28 pb-12 sm:pb-14 md:pb-16 lg:pb-20 px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-amber-400 font-semibold text-sm uppercase tracking-widest">Market Intelligence</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4">Research Reports</h1>
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl">In-depth market analysis and investment insights from our team of expert analysts</p>
        </div>
      </div>
      ...
      <div className="px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 pb-16 sm:pb-20 md:pb-24 lg:pb-32">
        <div className="max-w-6xl mx-auto">
                  ...
                  <div className="md:col-span-2 flex flex-col justify-between">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-cyan-400 font-bold text-xs uppercase tracking-widest">Featured Report</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Key Topics</div>
                      <div className="flex flex-wrap gap-2">
                        {featuredReport.topics.map((topic, i) => (
                          <span key={i} className="px-3 py-2 bg-cyan-500/15 text-cyan-300 text-xs font-bold rounded-lg border border-cyan-500/30 uppercase tracking-wider hover:bg-cyan-500/25 transition-colors">
                            {topic}
                          </span>
                        ))}
                      </div>
          ...
          <div className="mb-16 sm:mb-20">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-8">Latest Reports</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
              {reports.map((report, i) => {
                const Icon = report.icon;
                const colorSchemes = [
                  { icon: 'text-cyan-400', border: 'border-cyan-500/20 hover:border-cyan-500/40', bg: 'bg-cyan-500/10 hover:bg-cyan-500/15' },
                  { icon: 'text-orange-400', border: 'border-orange-500/20 hover:border-orange-500/40', bg: 'bg-orange-500/10 hover:bg-orange-500/15' },
                  { icon: 'text-violet-400', border: 'border-violet-500/20 hover:border-violet-500/40', bg: 'bg-violet-500/10 hover:bg-violet-500/15' },
                  { icon: 'text-pink-400', border: 'border-pink-500/20 hover:border-pink-500/40', bg: 'bg-pink-500/10 hover:bg-pink-500/15' },
                ];
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2 mb-6 pt-4 border-t border-slate-700/50">
                      {report.topics.map((topic, j) => (
                        <span key={j} className="text-xs bg-slate-800/60 text-slate-300 px-2 py-1 rounded border border-slate-700/40 font-medium">
                          {topic}
                        </span>
                      ))}
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-emerald-400 font-bold text-xs uppercase tracking-widest">Exclusive Insights</span>
                  </div>
                  <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 leading-tight">Never Miss a Market Move</h2>
                  <p className="text-slate-300 text-sm sm:text-base mb-2 leading-relaxed">
                    Get exclusive research reports delivered weekly. Our team of expert analysts provides sector analysis, market insights, and personalized investment recommendations.
                  </p>
                  <p className="text-xs text-slate-500">Free access for 2 weeks, then $29/month. Cancel anytime.</p>
                </div>
