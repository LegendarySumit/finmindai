...
const CommandCenter = () => {
  ...
  const marketStatus: "open" | "closed" =
    currentTime.getHours() >= 9 && currentTime.getHours() < 16
      ? "open"
      : "closed";
  ...
  const liveActivity = [
    {
      type: "prediction",
      message: "AAPL bullish — 85% confidence score",
      time: "2m ago",
      status: "success",
    },
    {
      type: "alert",
      message: "Fed rate decision alert triggered",
      time: "5m ago",
      status: "warning",
    },
    {
      type: "trade",
      message: "TSLA position closed — +8.2% return",
      time: "12m ago",
      status: "success",
    },
    {
      type: "news",
      message: "Breaking: Tech sector rally continues",
      time: "18m ago",
      status: "info",
    },
    {
      type: "prediction",
      message: "GOOGL bearish signal detected",
      time: "25m ago",
      status: "error",
    },
  ];
  ...
  return (
    <section
      id="dashboard"
      className="min-h-screen flex items-center justify-center bg-linear-to-br from-finance-darker via-finance-dark to-finance-darker pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16"
    >
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <div
                  className={`w-2 h-2 rounded-full ${marketStatus === "open" ? "bg-emerald-500" : "bg-red-500"} animate-pulse`}
                />
          ...
          <div className="mt-4 pt-4 border-t border-finance-border">
            ...
            <p className="text-center text-slate-400 mt-2 text-xs sm:text-sm md:text-base">
              ...
              predict markets, analyze live news, and master the art of
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-8">
          {metrics.map((metric, i) => {
            ...
            const colorClasses = {
              ...
              amber:
                "text-finance-gold bg-finance-gold/10 border-finance-gold/20",
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div
                      className={`w-8 h-8 rounded-lg ${colorClasses[metric.color as keyof typeof colorClasses]} flex items-center justify-center`}
                    >
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <span
                      className={`text-sm font-semibold ${metric.change.startsWith("+") ? "text-emerald-500" : metric.change.startsWith("-") ? "text-red-500" : "text-finance-gold"}`}
                    >
                      {metric.change}
                    </span>
                      ...
                      <motion.div
                        ...
                        className={`flex-1 rounded-t ${
                          metric.color === "emerald"
                            ? "bg-linear-to-t from-emerald-600 to-emerald-500"
                            : metric.color === "amber"
                              ? "bg-linear-to-t from-finance-gold to-finance-gold-bright"
                              : metric.color === "blue"
              ...
              {liveActivity.map((activity, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-white group-hover:text-finance-gold transition-colors">
                      {activity.message}
                    </p>
                    <span className="text-xs text-slate-500">
                      {activity.time}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-bold text-white group-hover:text-finance-gold transition-colors">
                        {action.label}
                      </p>
