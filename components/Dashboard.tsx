...
// Interfaces removed - not currently used in component
...
const PRED_CHART_DATA: Record<
  PredSymbol,
  { labels: string[]; close: number[]; volume: number[] }
> = {
  TSLA: {
    labels: [
      "Feb 19",
    ...
    close: [
      265.1, 258.4, 253.7, 248.0, 260.2, 255.8, 268.4, 261.0, 256.3, 270.1,
      263.9, 252.4, 259.7, 248.6,
    ],
  ...
  AAPL: {
    ...
    close: [
      191.0, 193.5, 196.2, 194.8, 197.1, 195.9, 199.2, 197.4, 196.0, 200.3,
      199.1, 197.8, 200.0, 198.5,
    ],
  ...
  NVDA: {
    ...
    close: [
      820, 838, 852, 845, 865, 858, 875, 862, 848, 881, 873, 861, 884, 892,
    ],
  ...
  "BTC/USD": {
    ...
    close: [
      84200, 85600, 83400, 86100, 88200, 85900, 89400, 87100, 85800, 90200,
      88700, 86300, 89100, 87420,
    ],
  ...
  "NIFTY 50": {
    ...
    close: [
      22100, 22350, 22180, 22420, 22680, 22510, 22760, 22590, 22380, 22810,
      22650, 22490, 22720, 22641,
    ],
  ...
  MSFT: {
    ...
    close: [
      405, 409, 412, 407, 415, 411, 418, 413, 410, 420, 417, 414, 419, 416,
    ],
...
const TIMEFRAME_DATA: Record<string, { labels: string[]; values: number[] }> = {
  "1D": {
    ...
    values: [
      2450000, 2463200, 2455800, 2473100, 2488400, 2479600, 2491200, 2485500,
      2497800, 2502300, 2511000, 2508400, 2519200, 2524700,
    ],
  },
  "1W": {
  ...
  "1Y": {
    ...
    values: [
      1920000, 2010000, 2080000, 2150000, 2230000, 2180000, 2290000, 2340000,
      2280000, 2370000, 2450000, 2524700,
    ],
  },
  ALL: {
...
const AI_INSIGHTS: InsightItem[] = [
  {
    ...
    desc: "Cup-and-handle on 4H with rising OBV. All-time high retest likely. Target: $960.",
    time: "4m ago",
    confidence: 91,
  },
  {
    type: "warning",
    title: "Portfolio Overweight: Tech",
    desc: "Tech exposure at 54%, above the 45% strategic threshold. Rotate 10-15% to Energy.",
    time: "31m ago",
    confidence: 83,
  },
  {
    type: "bearish",
    title: "BTC Triple-Top at $97K",
    desc: "Three rejections at $97K. Fibonacci retracement projects $88,400 as next support.",
    time: "1h ago",
    confidence: 74,
  },
  {
    type: "bullish",
    title: "RBI Cut: NIFTY Rate Catalyst",
    desc: "Expected 25bps cut Thursday. Banking & NBFC indices historically +3-5% in 7 days.",
    time: "2h ago",
    confidence: 87,
  },
  {
    type: "neutral",
    title: "CPI Print \u2014 Thursday 8:30 ET",
    desc: "Core CPI est. 3.1% YoY. Surprise in either direction may swing NASDAQ \u00B12%.",
    time: "3h ago",
    confidence: 78,
  },
];
...
const Card = ({
  ...
  <div
    className={`relative bg-[#0f172a]/70 backdrop-blur-xl border border-slate-800/60 rounded-2xl overflow-hidden ${className}`}
  >
  ...
  <motion.div variants={fadeUp}>
    <Card className="p-4 sm:p-5 hover:border-slate-700/80 transition-colors group cursor-default h-full">
      <div className="flex justify-between items-start mb-4">
        <div
          className={`p-2.5 rounded-xl border ${accentBg} ${accentColor} group-hover:scale-110 transition-transform`}
        >
          <Icon size={17} />
        </div>
        <span
      ...
      <p className="text-[9px] sm:text-[10px] font-black text-slate-600 uppercase tracking-[0.12em] sm:tracking-[0.15em] mb-1">
        {title}
      </p>
      <p className="text-xl min-[360px]:text-2xl font-extrabold text-white tracking-tight leading-none wrap-break-word">
        {value}
      </p>
...
const WatchlistRow = ({
  ...
  <div className="group flex items-center gap-3 px-3.5 py-3 rounded-xl bg-[#0d1320]/90 border border-slate-800/50 hover:border-slate-700/80 hover:bg-[#0d1320] transition-all cursor-pointer relative overflow-hidden">
    <div
      className={`absolute left-0 top-0 bottom-0 w-0.5 rounded-l-xl ${isPositive ? "bg-emerald-500/70" : "bg-rose-500/70"}`}
    />
    <div className="ml-1 flex-1 min-w-0">
      ...
      <div className="flex items-center justify-between">
        ...
        {loading ? (
          ...
          <span
            className={`text-[11px] font-bold flex items-center gap-0.5 ${isPositive ? "text-emerald-400" : "text-rose-400"}`}
          >
            {isPositive ? (
...
const InsightRow = ({ type, title, desc, time, confidence }: InsightItem) => {
  ...
  return (
    <div
      className={`flex gap-2 sm:gap-3 p-2.5 sm:p-3 md:p-3.5 rounded-lg sm:rounded-xl border border-slate-800/50 hover:border-slate-700 ${c.ring} cursor-pointer transition-all group`}
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2 mb-0.5 sm:mb-1">
          <h4 className="text-xs sm:text-sm md:text-[13px] font-bold text-slate-200 group-hover:text-white transition-colors leading-snug">
            {title}
          </h4>
          <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
            <span className={`text-[8px] sm:text-[9px] font-black ${c.text}`}>
              {confidence}%
            </span>
        ...
        <p className="text-xs sm:text-[11px] md:text-[12px] text-slate-600 leading-relaxed line-clamp-2">
          {desc}
        </p>
      </div>
    </div>
...
const Dashboard = () => {
  ...
  const [marketStatus, setMarketStatus] = useState<
    "open" | "premarket" | "closed"
  >("closed");
  const [activeTimeframe, setActiveTimeframe] = useState("1D");
  const [tsla, setTsla] = useState<StockQuote>({
    price: 0,
    change: 0,
    changePercent: 0,
    loading: true,
  ...
  // Stable random widths for watchlist bars (generated once on mount)
  const [watchlistBarWidths] = useState(() =>
    WATCHLIST_STATIC.reduce(
      (acc, item) => {
        acc[item.symbol] = Math.random() * 80 + 20;
        return acc;
      },
      {} as Record<string, number>,
    ),
  );
  const settlementTimersRef = useRef<
  ...
  // Fetch TSLA data on mount and polling
  useEffect(() => {
    let isMounted = true;
    const performFetch = async () => {
      if (isMounted) await fetchTsla();
    };
    performFetch();

    const id = setInterval(() => {
      if (isMounted) fetchTsla();
    }, 15_000);
    return () => {
      isMounted = false;
      clearInterval(id);
  ...
  const predTrend =
    predData.close[predData.close.length - 1] >= predData.close[0];
  const upOdds = predTrend ? 1.75 : 2.2;
  const downOdds = predTrend ? 2.2 : 1.75;
  const activeOdds =
    betDir === "up" ? upOdds : betDir === "down" ? downOdds : 0;
  ...
  // const totalBets = openBets.length; // Not used
  const wonBets = openBets.filter((b) => b.status === "won"); // Used in Results History
  const lostBets = openBets.filter((b) => b.status === "lost"); // Used in Results History
  const activeBets = openBets.filter((b) => b.status === "open"); // Used in render
  ...
  useEffect(() => {
    return () => {
      Object.values(settlementTimersRef.current).forEach((timer) =>
        clearTimeout(timer),
      );
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        ...
        callbacks: {
          label: (c: { raw: unknown }) =>
            `₹${((c.raw as number) / 100000).toFixed(2)}L`,
        },
      },
    },
    scales: {
  ...
  return (
    <section
      id="dashboard"
      className="min-h-screen bg-[#020617] text-slate-200 font-sans pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16 md:pb-20 px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 relative overflow-x-hidden"
    >
      {/* -- Ambient glows -- */}
      <div
        className="absolute top-0 right-0 w-96 sm:w-150 h-72 sm:h-125 rounded-full pointer-events-none blur-3xl opacity-40"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-0 left-0 w-80 sm:w-125 h-80 sm:h-125 rounded-full pointer-events-none blur-3xl opacity-40"
        style={{
          background:
      ...
      />
      <div
        className="absolute top-1/3 left-1/2 w-96 sm:w-150 h-64 sm:h-100 rounded-full pointer-events-none blur-3xl opacity-30"
        style={{
          background:
        ...
        >
          <motion.div variants={fadeUp}>
            <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
              ...
              <span className="text-[8px] sm:text-[9px] md:text-[10px] font-black text-amber-500 uppercase tracking-[0.15em] sm:tracking-[0.2em]">
                Live Interface
              </span>
            </div>
            ...
            <p className="text-slate-500 text-xs sm:text-sm md:text-base mt-1 sm:mt-1.5">
              FinMind AI &middot; Real-Time Portfolio Analytics &middot; Smart
              Compounding
            </p>
          </motion.div>
          ...
          >
            ...
            <Card className="px-2 sm:px-4 py-2 sm:py-3 flex flex-col min-[360px]:flex-row items-start min-[360px]:items-center gap-2 sm:gap-4 flex-1 sm:flex-none">
              <div>
                <div className="text-[7px] sm:text-[8px] md:text-[9px] text-slate-600 font-bold uppercase tracking-widest">
                  New York
                </div>
              ...
              <div>
                <div className="text-[7px] sm:text-[8px] md:text-[9px] text-slate-600 font-bold uppercase tracking-widest mb-0.5">
                  NYSE
                </div>
                <div
                  className={`text-xs sm:text-sm md:text-[13px] font-black flex items-center gap-1 sm:gap-1.5 ${msCfg.color}`}
                >
                  <span
                    className={`w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full ${msCfg.dot} ${marketStatus === "open" ? "animate-pulse" : ""}`}
                  />
                  {msCfg.label}
                </div>
              </div>
            ...
            >
              <RefreshCw
                size={14}
                className={tsla.loading ? "animate-spin" : ""}
              />
            </button>
          </motion.div>
        </motion.div>
            ...
            <Card className="p-5 flex flex-col">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-400 uppercase tracking-wider">
                    BETA
                  </span>
                </div>
                {/* Symbol tabs */}
              ...
              <div className="flex flex-col min-[360px]:flex-row min-[360px]:items-baseline gap-x-3 gap-y-1 mb-4">
                <span className="text-xl min-[360px]:text-2xl sm:text-3xl font-extrabold text-white font-mono">
                  {predPrice.currency}
                  {predPrice.price.toLocaleString()}
                </span>
                <span
                  className={`text-xs sm:text-sm font-bold flex items-center gap-1 ${predTrend ? "text-emerald-400" : "text-rose-400"}`}
                >
                  {predTrend ? (
                  ...
                  {predTrend ? "+" : ""}
                  {(
                    ((predData.close[predData.close.length - 1] -
                      predData.close[0]) /
                      predData.close[0]) *
                    100
                  ).toFixed(2)}
                ...
                <span className="w-full sm:w-auto sm:ml-auto text-[10px] text-slate-600 mt-1 sm:mt-0">
                  Range: {predPrice.currency}
                  {predMin.toLocaleString()} - {predPrice.currency}
                  {predMax.toLocaleString()}
                </span>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="grid grid-cols-3 gap-3 mb-3">
                  <div className="col-span-3 p-4 rounded-xl border border-finance-gold/30 bg-finance-gold/5 hover:border-finance-gold/50 transition-all">
                    <div className="text-[10px] text-slate-600 font-black uppercase tracking-widest mb-1.5">
                      Total Portfolio Value
                    </div>
                    <div className="flex flex-col min-[420px]:flex-row min-[420px]:items-baseline gap-1.5 min-[420px]:gap-2">
                      <span className="text-xl min-[360px]:text-2xl font-black text-finance-gold">
                        ₹25,47,500
                      </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={alloc.label}
                      className="p-3.5 rounded-xl border border-slate-800/50 bg-[#0d1320]/90 hover:border-slate-700 transition-all group"
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div
                          className={`text-[11px] font-black ${alloc.color} uppercase tracking-widest`}
                        >
                          {alloc.label}
                        </div>
                        <div className={`text-[10px] font-bold ${alloc.color}`}>
                          {alloc.pct.toFixed(1)}%
                        </div>
                      </div>
                    ...
                    {activeBets.length === 0 ? (
                      <div className="flex flex-1 items-center justify-center">
                        <div className="text-center">
                          <div className="text-sm font-black text-slate-300 uppercase tracking-wider mb-1">
                            No current active predictions
                          </div>
                          <div className="text-xs text-slate-500">
                            Place a prediction to see it appear here.
                          </div>
                        </div>
                      </div>
                    ) : (
                      <div className="space-y-3 overflow-y-auto custom-scrollbar pr-1 flex-1">
                        {activeBets.map((bet) => (
                          <motion.div
                            ...
                            className="p-4 rounded-xl bg-[#0d1320] border border-amber-500/30 hover:border-amber-500/50 transition-all hover:shadow-lg hover:shadow-amber-500/10"
                          >
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-3">
                                <div
                                  className={`w-9 h-9 rounded-lg flex items-center justify-center text-[10px] font-black border ${
                                    bet.direction === "up"
                                ...
                                <div>
                                  ...
                                  <div
                                    className={`text-[10px] font-bold tracking-wide ${bet.direction === "up" ? "text-emerald-400" : "text-rose-400"}`}
                                  >
                                    {bet.direction === "up"
                                      ? "↑ LONG"
                                      : "↓ SHORT"}
                            ...
                            <div className="grid grid-cols-3 gap-3 text-[8px] text-slate-600 pt-3 border-t border-slate-800/50">
                              <div>
                                <div className="text-slate-500 font-bold uppercase text-[7px] tracking-wider mb-1">
                                  Stake
                                </div>
                                <div className="text-slate-300 font-bold text-[10px]">
          ...
          <motion.div variants={fadeUp} className="flex min-h-0 flex-col gap-4">
            ...
            <Card className="p-5 shrink-0">
              ...
              <div className="mb-4 p-3 rounded-xl bg-[#0d1320] border border-slate-800/50">
                <div className="text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2.5">
                  Select Company (From Chart Analysis)
                </div>
                <div className="grid grid-cols-3 gap-2 mb-3">
                  {PREDICTION_SYMBOLS.map((sym) => (
                    ...
                    >
                      <div
                        className={`text-[11px] font-black ${predSymbol === sym ? "text-finance-gold" : "text-slate-300"}`}
                      >
                        {sym}
                      </div>
                      <div className="text-[9px] text-slate-500 mt-0.5">
                        {PRED_PRICES[sym].currency}
                        {PRED_PRICES[sym].price.toLocaleString()}
                      </div>
                    </motion.button>
                  ))}
                </div>
                ...
                <div className="text-[10px] text-slate-400 p-2 rounded-lg bg-slate-900/40">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-black text-slate-200">
                      {PRED_PRICES[predSymbol].currency}
                      {PRED_PRICES[predSymbol].price.toLocaleString()}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                ...
                >
                  {betDir === "up" && (
                    <motion.div
                      className="absolute inset-0 bg-linear-to-r from-transparent via-emerald-500/20 to-transparent"
                      animate={{ x: ["100%", "-100%"] }}
                ...
                >
                  {betDir === "down" && (
                    <motion.div
                      className="absolute inset-0 bg-linear-to-r from-transparent via-rose-500/20 to-transparent"
                      animate={{ x: ["100%", "-100%"] }}
                      transition={{ duration: 1.5, repeat: Infinity }}
                    />
                  )}
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-[9px] font-black text-slate-600 uppercase tracking-widest">
                    Stake (Virtual Currency)
                  </label>
                  {stakeNum > 0 && (
                    <span className="text-[8px] font-bold text-emerald-400">
                      ₹{stakeNum.toLocaleString()}
                    </span>
                  )}
                </div>
              ...
              {/* Expiry - Enhanced */}
              <div className="mb-4">
                <label className="text-[9px] font-black text-slate-600 uppercase tracking-widest block mb-1.5">
                  Expires
                </label>
              ...
              >
                <div className="grid grid-cols-3 gap-2 mb-3">
                  ...
                  >
                    <div className="text-[9px] text-slate-700 mb-0.5 uppercase tracking-wider">
                      Odds
                    </div>
                    <motion.div
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      animate={
                        potentialReturn > 0 ? { scale: [1, 1.1, 1] } : {}
                      }
                      transition={{ duration: 0.4 }}
                    >
                      {potentialReturn > 0
                  ...
                  >
                    ...
                    >
                      {potentialReturn > 0
                        ? `+₹${(potentialReturn - stakeNum).toFixed(0)}`
                        : "-"}
                    </motion.div>
                  </motion.div>
                </div>
                ...
                {potentialReturn > 0 && (
                  <div className="h-1.5 bg-slate-900 rounded-full overflow-hidden">
                    <motion.div
                      ...
                      initial={{ width: 0 }}
                      animate={{
                        width: `${Math.min(((potentialReturn - stakeNum) / stakeNum) * 100, 100)}%`,
                      }}
              ...
              >
                ...
                <span className="relative z-10">
                  {betPlaced
                    ? "✓ Prediction Placed!"
                    : betDir && stakeNum > 0
                      ? `Predict ${betDir === "up" ? "LONG ↑" : "SHORT ↓"} on ${predSymbol}`
                      : "Select direction & stake"}
                </span>
              </motion.button>
              ...
              <p className="text-[8px] text-slate-700 text-center mt-2">
                Virtual currency only • for educational simulation purposes
              </p>
            </Card>
              ...
              <motion.div variants={fadeUp}>
                <Card className="p-5 h-140 flex flex-col">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[9px] font-bold text-slate-700 bg-slate-800/50 px-2.5 py-1 rounded-lg">
                      {lostBets.length} settled
                    </span>
                  </div>
                      ...
                      .map((bet) => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-2.5">
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-7 h-7 rounded-lg flex items-center justify-center text-[9px] font-black border ${
                                  bet.direction === "up"
                                    ? "bg-emerald-500/20 border-emerald-500/40 text-emerald-400"
                                    : "bg-rose-500/20 border-rose-500/40 text-rose-400"
                                }`}
                              ...
                              <div>
                                ...
                                <div
                                  className={`text-[9px] font-bold tracking-wide ${bet.direction === "up" ? "text-emerald-400" : "text-rose-400"}`}
                                >
                                  {bet.direction === "up"
                                    ? "↑ LONG"
                                    : "↓ SHORT"}
                            ...
                            <div className="text-right">
                              <div
                                className={`text-[9px] font-black mb-0.5 ${bet.status === "won" ? "text-emerald-400" : "text-rose-400"}`}
                              >
                                {bet.status === "won" ? "✓ WON" : "✗ LOST"}
                              </div>
                              <div
                                className={`text-[11px] font-black ${bet.status === "won" ? "text-emerald-400" : "text-rose-400"}`}
                              >
                                {bet.status === "won" ? "+" : "-"}₹
                                {Math.abs(
                                  bet.status === "won"
                          ...
                          <div className="grid grid-cols-3 gap-2.5 text-[7px] text-slate-600 border-t border-slate-800/50 pt-2.5">
                            <div>
                              ...
                              <div className="text-slate-300 font-semibold text-[9px]">
                                ₹{bet.stake.toLocaleString()}
                              </div>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <div
                                className={`font-semibold text-[9px] ${bet.status === "won" ? "text-emerald-400" : "text-rose-400"}`}
                              >
                                {bet.status === "won" ? "+" : "-"}
                                {(
                                  (Math.abs(
        ...
        >
          ...
          <motion.div variants={fadeUp} className="lg:col-span-2">
            <Card className="p-6 h-full flex flex-col">
              ...
              <div
                className="flex-1"
                style={{ minHeight: isTinyScreen ? "200px" : "240px" }}
              >
              ...
              <div className="grid grid-cols-2 min-[420px]:grid-cols-4 gap-3 mt-5 pt-4 border-t border-slate-800/60">
                {[
                  ...
                  <div key={s.label}>
                    <div className="text-[9px] text-slate-600 font-bold uppercase tracking-wider mb-0.5">
                      {s.label}
                    </div>
            ...
            <Card className="p-5 h-full flex flex-col">
              ...
              <WatchlistRow
                ...
                pct={
                  tsla.loading
                    ? "..."
                    : `${tslaPos ? "+" : ""}${tsla.changePercent.toFixed(2)}%`
                }
                isPositive={tslaPos}
                exchange="NASDAQ"
            ...
            <Card className="p-5 h-full flex flex-col">
                  ...
                  <div key={label} className="flex items-center gap-2.5">
                    ...
                    <div className="w-16 h-1 bg-slate-800 rounded-full overflow-hidden shrink-0">
                      <div
                        ...
                        style={{
                          width: `${ALLOCATION_VALUES[i]}%`,
                          background: ALLOCATION_COLORS[i],
                        }}
                      />
                    </div>
                    <span className="text-[11px] font-bold text-slate-300 font-mono w-7 text-right">
                      {ALLOCATION_VALUES[i]}%
                    </span>
                  </div>
                ))}
              ...
              <div className="mt-4 pt-4 border-t border-slate-800/60 grid grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={s.label}
                    className="flex flex-col gap-0.5 p-3 rounded-xl bg-[#0d1320]/80 border border-slate-800/50"
                  >
                    <span className="text-[9px] text-slate-600 uppercase tracking-wider font-bold">
                      {s.label}
                    </span>
                    <span
                      className={`text-[13px] font-extrabold font-mono ${s.color}`}
                    >
                      {s.value}
                    </span>
              ...
              <div className="mt-3 flex items-start gap-2.5 p-3 rounded-xl bg-amber-500/5 border border-amber-500/15">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[10px] text-slate-500 leading-relaxed">
                    Tech overweight at 37% vs 30% target. Rotate 7% into Energy
                    &amp; Financials to reduce concentration risk.
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3 pt-3 border-t border-slate-800/60 flex items-center justify-between">
                ...
                <button className="text-[9px] font-bold text-blue-400 hover:text-blue-300 transition-colors uppercase tracking-wider">
                  Rebalance Now
                </button>
              </div>
            </Card>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Live watchlist with detailed analytics
                    </p>
                  </div>
                </div>
                <motion.button
                ...
                {WATCHLIST_STATIC.map((stock, idx) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 text-xs">
                      <span className="px-2.5 py-1 rounded-lg bg-slate-800/60 text-slate-400 font-semibold">
                        {stock.exchange}
                      </span>
                      <div className="flex-1 h-1.5 bg-slate-800 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${watchlistBarWidths[stock.symbol] ?? 50}%`,
                          }}
                        />
                      </div>
                    </div>
