        ...
        <div className="flex justify-between items-center h-12 sm:h-14 md:h-16">
          ...
          >
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="hidden min-[375px]:block text-[8px] sm:text-[9px] md:text-[10px] text-slate-500 uppercase tracking-widest -mt-0.5 sm:-mt-0.5 md:-mt-1">
                Financial Intel
              </span>
            </div>
          </motion.a>
          ...
          <nav className="hidden md:flex items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  className={`w-3 h-3 transition-transform ${exploreDropdownOpen ? "rotate-180" : ""}`}
                />
              </motion.button>
