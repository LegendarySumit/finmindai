      ...
      <div className="fixed top-12 sm:top-14 md:top-16 left-0 right-0 overflow-hidden backdrop-blur-sm py-1.5 sm:py-2 z-20 bg-finance-darker/80">
        ...
        >
          {[...TICKERS, ...TICKERS].map((t, i) => (
            <span
              key={i}
              className="inline-flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs font-bold tracking-wide"
            >
              ...
              <span
                className={`${t.up ? "text-emerald-400" : "text-red-400"} text-[10px] sm:text-xs`}
              >
                {t.up ? "▲" : "▼"} {t.change}
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8 md:gap-10 lg:gap-12 items-center">
            ...
            <div className="space-y-3.5 sm:space-y-5 md:space-y-6 lg:space-y-7">
              ...
              >
                ...
                <span className="text-[10px] sm:text-sm text-finance-gold font-bold uppercase tracking-wider">
              ...
              >
                Deploy elite trading strategies, analyze institutional-grade
                market data, and outperform AI predictions.
              </motion.p>
              ...
              >
                {[
                  ...
                  <div
                    key={i}
                    className="bg-finance-card/60 border border-finance-border rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-3 text-center backdrop-blur-sm min-w-0"
                  >
                    <p
                      className={`text-sm sm:text-sm md:text-base font-black ${s.color}`}
                    >
                      {s.value}
                    </p>
            ...
            >
              ...
              <div className="relative bg-finance-card/90 backdrop-blur p-4 sm:p-6 md:p-8 rounded-2xl border border-finance-gold/20 shadow-2xl shadow-finance-gold/10">
                ...
                <div className="flex justify-between items-start mb-4 sm:mb-5 md:mb-6">
                  <div>
                    <p className="text-slate-400 text-xs mb-1 sm:mb-2 uppercase tracking-wider font-semibold">
                      Portfolio Value
                    </p>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 pt-3 sm:pt-4 border-t border-finance-border">
                  {[
                    ...
                    <motion.div key={i} whileHover={{ scale: 1.06 }}>
                      ...
                      <p
                        className={`font-bold text-sm sm:text-base md:text-lg ${s.color}`}
                      >
                        {s.value}
                      </p>
                    </motion.div>
