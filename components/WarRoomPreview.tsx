...
const WarRoomPreview = () => {
  ...
  const [displayPrices, setDisplayPrices] = useState<number[]>([
    45, 52, 48, 65, 58, 72, 68, 75, 82, 78, 85, 92,
  ]);
  ...
  const fetchStock = useCallback(async () => {
    try {
      ...
      const updated = [...priceHistoryRef.current, data.price].slice(-12);
  ...
  return (
    <section
      id="playground"
      className="min-h-screen relative pt-12 sm:pt-14 md:pt-16 pb-10 sm:pb-14 md:pb-20 lg:pb-24 overflow-hidden bg-finance-darker px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8"
    >
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center pt-6 sm:pt-8 md:pt-10 mb-10 sm:mb-12 md:mb-14 lg:mb-16">
          ...
          >
            Test your market instincts against our AI. Battle-tested strategies.
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(ellipse at top left, ${stat.color}14, transparent 70%)`,
                  }}
                />
                {/* watermark icon */}
                <Icon
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(13,17,30,0.97) 0%, rgba(10,14,24,0.99) 100%)",
          }}
        >
          {/* Terminal chrome bar */}
          ...
          <div className="grid lg:grid-cols-5 divide-y lg:divide-y-0 lg:divide-x divide-finance-border/30">
            ...
            <div className="lg:col-span-2 p-8 flex flex-col justify-between gap-6">
              <div>
                ...
                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                  Challenge our AI in live market prediction battles. Compete on
                  leaderboards, and sharpen your trading instincts.
                </p>
            ...
            <div className="lg:col-span-2 p-6 flex flex-col gap-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs bg-finance-gold/10 border border-finance-gold/20 text-finance-gold px-2 py-0.5 rounded font-bold">
                          NASDAQ
                        </span>
                      </div>
                    ...
                    <div className="text-right">
                      ...
                      <div
                        className={`flex items-center gap-1 justify-end ${stock.change >= 0 ? "text-emerald-400" : "text-red-400"}`}
                      >
                        <TrendingUp
                          className={`w-3 h-3 ${stock.change < 0 ? "rotate-180" : ""}`}
                        />
              ...
              <div className="flex-1">
                <LiveBars prices={displayPrices} />
              </div>
              <div className="flex justify-between text-xs text-slate-600">
                <span>Session start</span>
                <span
                  className={
                    lastUpdated ? "text-emerald-400" : "text-slate-600"
                  }
                >
                  {lastUpdated
              ...
              <div className="rounded-xl border border-finance-border/50 p-4 bg-finance-darker/70">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-black text-finance-gold">
                    Round 7 / 10
                  </span>
                </div>
                ...
                <div className="mt-3 h-1.5 bg-finance-border/30 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    style={{
                      transformOrigin: "left",
                      background:
                        "linear-gradient(90deg, #a78bfa 0%, #ef4444 45%, #34d399 100%)",
                    }}
                  />
                </div>
              </div>
                ...
                {leaderboard.map((entry, i) => (
                  <motion.div
                    ...
                    className={`rounded-lg p-2.5 border transition-colors ${
                      (entry as typeof entry & { highlight?: boolean })
                        .highlight
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-xs font-bold flex-1 truncate ${(entry as typeof entry & { highlight?: boolean }).highlight ? "text-purple-300" : "text-slate-300"}`}
                      >
                        {entry.name}
                      </span>
                    </div>
